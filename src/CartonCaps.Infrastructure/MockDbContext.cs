...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MockDbContext"/> class with the specified options.
    /// </summary>
    ...
    public void SeedData()
    {
        ...
        if (!Referrals.Any())
        {
            Referrals.AddRange(new List<Referral>
            {
                ...
                new Referral { ReferralId = new Guid("13d2920e-f5c4-4ee6-a97a-1ff50d55eda8"), UserId = new Guid("29fd60d2-cf8b-4f93-ab8b-d9e5d768fc1a"), ReferredDeepLink = "https://cartoncaps.link/pqj82jabb9q?referralCode=AL1C3B", Status = ReferralStatus.Completed, ClaimedByUserId = new Guid("b1c2d3e4-f5a6-7b8c-9d0e-f1a2b3c4d5e6"), ClaimedByUserName = "Kathleen H." },
                ...
                new Referral { ReferralId = new Guid("32e765a3-7cb7-4872-a1fe-1cebbe313300"), UserId = new Guid("b1c2d3e4-f5a6-7b8c-9d0e-f1a2b3c4d5e6"), ReferredDeepLink = "https://cartoncaps.link/ddb4int09u9?referralCode=KT5Y8B", Status = ReferralStatus.Completed, ClaimedByUserId = new Guid("c1d2e3f4-a5b6-7c8d-9e0f-1a2b3c4d5e6f"), ClaimedByUserName = "Debbie H." },
